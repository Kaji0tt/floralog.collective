...
- Persistent entities and authoritative schemas live server-side and are not included in this frontend repo.
To add them here, export API schemas (OpenAPI / JSON Schema) or example responses; they can then be incorporated into `docs/` and `src/api/entities.js` for developer reference.
