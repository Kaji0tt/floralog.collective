...
import { Leaf, SlidersHorizontal, Loader2 } from "lucide-react";
...
export default function FriendCollectionPanel({ friendEmail, friendUser, averageColor }) {
  ...
  const contentLoading = generaLoading || plantsLoading || discoveriesLoading;
  ...
  if (contentLoading && genera.length === 0) {
    return (
