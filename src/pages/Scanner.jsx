              ...
              if (match) {
                ...
                try {
                  ...
                  return {
                    ...
                    wild_bees_count: meta.wild_bees_count ?? plantData.wild_bees_count ?? null,
                    butterflies_count: meta.butterflies_count ?? plantData.butterflies_count ?? null,
                    caterpillars_count: meta.caterpillars_count ?? plantData.caterpillars_count ?? null,
                    hoverflies_count: meta.hoverflies_count ?? plantData.hoverflies_count ?? null,
                    beetles_count: meta.beetles_count ?? plantData.beetles_count ?? null,
                    red_list_threat: meta.red_list_threat ?? plantData.red_list_threat ?? null,
                    red_list_population: meta.red_list_population ?? plantData.red_list_population ?? null,
                    nectar_value: meta.nectar_value ?? plantData.nectar_value ?? null,
                    pollen_value: meta.pollen_value ?? plantData.pollen_value ?? null,
