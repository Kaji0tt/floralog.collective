    ...
    <>
      ...
      >
          <motion.div
            ...
            className={`relative h-full w-full max-w-md md:max-w-3xl rounded-[2rem] overflow-hidden ${isLightUi ? "shadow-[0_20px_64px_rgba(0,0,0,0.14)]" : "shadow-[0_20px_80px_rgba(0,0,0,0.55)]"}`}
          >
