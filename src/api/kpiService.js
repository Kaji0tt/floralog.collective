...
const ACTION_EVENT_LABELS = {
  ...
  home_customize_open: "Anpassen öffnen",
  home_health_open: "Pflanzengesundheit öffnen",
  home_options_open: "Optionsmenü öffnen",
  home_settings_open: "Einstellungen öffnen",
  home_bug_report_open: "Bugreport öffnen",
  home_server_news_open: "Server-News öffnen",
  home_imprint_open: "Impressum öffnen",
  home_quiz_open: "Pflanzenquiz öffnen",
  home_event_stripe_weekly: "Wochenaufgabe öffnen",
  home_event_stripe_monthly: "Monatsaufgabe öffnen",
  home_badge_customize_open: "Abzeichen anpassen",
  home_shop_stack_save: "Anpassungen speichern",
  home_panel_return: "Header → Home",
  bottomnav_home: "Home öffnen",
  bottomnav_collection: "Kollektion öffnen",
  bottomnav_achievements: "Aufgaben öffnen",
  bottomnav_map: "Karte öffnen",
  bottomnav_social: "Log öffnen",
  achievements_view_leaderboard: "Aufgaben → Rangliste",
  achievements_view_quests: "Aufgaben → Aufgaben",
  achievements_view_achievements: "Aufgaben → Vergleiche",
  social_tab_explorer: "Log → Forscher-Log",
  social_tab_news: "Log → Neuigkeiten",
  social_tab_friends: "Log → Freunde",
  home_logo_overlay_open: "Logo-Overlay öffnen (Legacy)",
  home_overlay_health_stats: "Pflanzenstatus (Legacy)",
  home_overlay_shop_open: "Overlay-Shop (Legacy)",
  home_milestone_action: "Milestone-Aktion (Legacy)",
};

const ACTION_EVENT_COLORS = {
  home_scan_click: "#16a34a",
  home_customize_open: "#d97706",
  home_health_open: "#e11d48",
  home_options_open: "#57534e",
  home_settings_open: "#78716c",
  home_bug_report_open: "#dc2626",
  home_server_news_open: "#0284c7",
  home_imprint_open: "#64748b",
  home_quiz_open: "#059669",
  home_event_stripe_weekly: "#f59e0b",
  home_event_stripe_monthly: "#f97316",
  home_badge_customize_open: "#ca8a04",
  home_shop_stack_save: "#65a30d",
  home_panel_return: "#94a3b8",
  bottomnav_home: "#15803d",
  bottomnav_collection: "#6366f1",
  bottomnav_achievements: "#8b5cf6",
  bottomnav_map: "#06b6d4",
  bottomnav_social: "#10b981",
  achievements_view_leaderboard: "#fbbf24",
  achievements_view_quests: "#fb923c",
  achievements_view_achievements: "#fdba74",
  social_tab_explorer: "#34d399",
  social_tab_news: "#6ee7b7",
  social_tab_friends: "#a7f3d0",
};
